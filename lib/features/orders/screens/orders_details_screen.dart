...
import 'package:girdhari/widgets/orders_details/order_deteils_product_card.dart';
import 'package:girdhari/widgets/orders_details/orders_details_client_card.dart';
            ...
            child: Column(
              children: [
                OrdersDetailsClientCard(
                    modifyBillProduct: modifyBillProduct, order: widget.order)
                // Container(
                ...
                Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                              onTap: () {},
                              child: OrderDeteilsProductCard(
                                  modifyBillProduct: modifyBillProduct,
                                  index: index)
                              //   child: Container(
...
//////////////////////////////////  printer button  /////////////////////////////
                      ...
                      SqureIconButton(
                          ...
                          onPress: () {
                            debugPrint("...........triggred...........");
                            debugPrint(modifyBillProduct.clientModel.clientName
                                .toString());
                            debugPrint(modifyBillProduct.modifiedProductList
                                .toString());
                            //TODO for getting newUpdatedwholeSellPrice use following
                            //          modifyBillProduct
                            //                           .modifiedProductList[
                            //                               index]
                            //                           .totalPrice /
...
//                                                       BillingProductModel(
//                                                         totalPrice:  widget.orderProductList[index].totalPrice,
//                                                           id: widget
//                                                               .orderProductList[
//                                                                   index]
//                                                               .id,
